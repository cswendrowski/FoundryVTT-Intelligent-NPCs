...
import {renderWorldConfig} from "./hooks/renderWorldConfig.mjs";
import {renderDrawingConfig} from "./hooks/renderDrawingConfig.mjs";
...
Hooks.on("renderWorldConfig", renderWorldConfig);
...
Hooks.on("renderDrawingConfig", renderDrawingConfig);
